...
public class MemoryAccess {
   ...
   public static void loadValues() {
      boolean isSimilar = (MemoryAccess.MEM_WB_ALU_OUTPUT == Execution.EX_MEM_ALU_OUTPUT) && (MemoryAccess.MEM_WB_IR == Execution.EX_MEM_IR);
      ...
      if (!isSimilar) {
         Execution.hasOldVal = true;
      }
      
      
         MemoryAccess.hasOldVal = false;
   }
